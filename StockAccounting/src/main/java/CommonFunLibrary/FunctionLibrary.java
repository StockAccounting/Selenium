...
public class FunctionLibrary
{
	...
	public static WebDriver startBrowser(WebDriver driver) throws Exception
	{
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("Firefox"))
		{
			...
			{
				System.setProperty("webdriver.chrome.driver", "C:\\NewOJT\\StockAccounting\\ExecutableFiles\\chromedriver.exe");
				driver = new ChromeDriver();
			}else
				if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("IE"))
				{
					System.setProperty("webdriver.ie.driver", "C:\\NewOJT\\StockAccounting\\ExecutableFiles\\IEDriverServer.exe");
...
public static void typeAction(WebDriver driver,String locatorType,String locatorValue,String data)
	...
	public static void captureData(WebDriver driver, String locattype,String locatorvalue) throws Throwable
	{
		String data="";
		...
		FileWriter fw=new FileWriter("C:\\NewOJT\\VasuDeva\\CaptureData\\Data.txt");
	...
	{
		FileReader fr=new FileReader("C:\\NewOJT\\VasuDeva\\CaptureData\\Data.txt");
...
("//*[@id='ewContentColumn']/div[3]/form/div/div//table[@id='tbl_a_supplierslist']/tbody/tr["+i+"]/td["+column1+"]/div/span/span")).getText();
